  ...
  return (
    <main className="py-14 md:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <h1
          className={`text-4xl md:text-5xl text-center tracking-tight font-semibold mb-3 ${montserrat.className}`}
        >
          Our Services
        </h1>
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                  <h3 className="text-3xl md:text-4xl tracking-tight font-semibold mb-4">
                    {service.title}
                  </h3>
                ...
                <div className="md:w-1/2 w-full rounded-2xl overflow-hidden shadow-lg">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="w-full h-[260px] md:h-[340px] object-cover hover:scale-105 transition-transform duration-700"
                  />
                </div>
              </motion.div>
            );
        ...
        <div className="py-16">
          ...
          <div className="bg-[#e5e7eb] w-full rounded-2xl overflow-hidden relative h-[400px] shadow-lg">
            <iframe
